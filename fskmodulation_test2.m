...
receivedSignal   = [SymbolOne SymbolZero SymbolZero SymbolOne SymbolZero SymbolOne SymbolOne SymbolZero]; 
subplot(4,2,3);
stem(receivedSignal);
axis([-10 500 -2 2]);
xlabel('received signal');

DecodingZero     = receivedSignal .* [SymbolZero SymbolZero SymbolZero SymbolZero SymbolZero SymbolZero SymbolZero SymbolZero];
DecodingOne      = receivedSignal .* [SymbolOne SymbolOne SymbolOne SymbolOne SymbolOne SymbolOne SymbolOne SymbolOne];
